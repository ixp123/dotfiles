...
static const char *colors[][3]      = {
    ...
    [SchemeStatus]  = { col_gray3, col_gray1,  "#000000"  }, // Statusbar right {text,background,not used but
    [SchemeTagsSel]  = { col_gray4, col_cyan,  "#000000"  }, // Tagbar left selected {text,background,not use
    [SchemeTagsNorm]  = { col_gray3, col_gray1,  "#000000"  }, // Tagbar left unselected {text,background,no
    [SchemeInfoSel]  = { col_gray4, col_gray1,  "#000000"  }, // infobar middle  selected {text,background,no
    [SchemeInfoNorm]  = { col_gray3, col_gray1,  "#000000"  }, // infobar middle  unselected {text,backgroun
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-c", "-l", "20", "-p", " ", topbar ? NULL : "-b", NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *slockcmd[] = { "slock", NULL  };
static const char *flamecmd[] = { "flameshot", "gui", NULL };
static const char *pwrcmd[]   = { "/home/beau/.local/share/dmenu/powermenu", NULL };
