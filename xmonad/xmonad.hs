...
--
main = do 
  xmproc <- spawnPipe "xmobar -x 0 /home/beau/.config/xmobar/xmobarrc"
...
defaults = def {
      ...
      -- hooks, layouts
        layoutHook         = myLayout, gaps [(U,25), (R,25), (L,25) (D,25)] $ Tall 1 (3/100) (1/2) ||| Full  -- leave gaps at the top and right
